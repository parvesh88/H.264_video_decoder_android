...
static const CodecProfileLevel kProfileLevels[] = {
    ...
    { OMX_VIDEO_AVCProfileExtended,     OMX_VIDEO_AVCLevel1  },
    { OMX_VIDEO_AVCProfileExtended,     OMX_VIDEO_AVCLevel1b },
    { OMX_VIDEO_AVCProfileExtended,     OMX_VIDEO_AVCLevel11 },
    { OMX_VIDEO_AVCProfileExtended,     OMX_VIDEO_AVCLevel12 },
    { OMX_VIDEO_AVCProfileExtended,     OMX_VIDEO_AVCLevel13 },
    { OMX_VIDEO_AVCProfileExtended,     OMX_VIDEO_AVCLevel2  },
    { OMX_VIDEO_AVCProfileExtended,     OMX_VIDEO_AVCLevel21 },
    { OMX_VIDEO_AVCProfileExtended,     OMX_VIDEO_AVCLevel22 },
    { OMX_VIDEO_AVCProfileExtended,     OMX_VIDEO_AVCLevel3  },
    { OMX_VIDEO_AVCProfileExtended,     OMX_VIDEO_AVCLevel31 },
    { OMX_VIDEO_AVCProfileExtended,     OMX_VIDEO_AVCLevel32 },
    { OMX_VIDEO_AVCProfileExtended,     OMX_VIDEO_AVCLevel4  },
    { OMX_VIDEO_AVCProfileExtended,     OMX_VIDEO_AVCLevel41 },
    { OMX_VIDEO_AVCProfileExtended,     OMX_VIDEO_AVCLevel42 },
    { OMX_VIDEO_AVCProfileExtended,     OMX_VIDEO_AVCLevel5  },
    { OMX_VIDEO_AVCProfileExtended,     OMX_VIDEO_AVCLevel51 },
    { OMX_VIDEO_AVCProfileExtended,     OMX_VIDEO_AVCLevel52 },
    ...
    { OMX_VIDEO_AVCProfileHigh10,     OMX_VIDEO_AVCLevel1b },
    ...
    { OMX_VIDEO_AVCProfileHigh422,     OMX_VIDEO_AVCLevel1b },
    ...
    { OMX_VIDEO_AVCProfileHigh444,     OMX_VIDEO_AVCLevel1  },
    { OMX_VIDEO_AVCProfileHigh444,     OMX_VIDEO_AVCLevel1b },
    { OMX_VIDEO_AVCProfileHigh444,     OMX_VIDEO_AVCLevel11 },
    { OMX_VIDEO_AVCProfileHigh444,     OMX_VIDEO_AVCLevel12 },
    { OMX_VIDEO_AVCProfileHigh444,     OMX_VIDEO_AVCLevel13 },
    { OMX_VIDEO_AVCProfileHigh444,     OMX_VIDEO_AVCLevel2  },
    { OMX_VIDEO_AVCProfileHigh444,     OMX_VIDEO_AVCLevel21 },
    { OMX_VIDEO_AVCProfileHigh444,     OMX_VIDEO_AVCLevel22 },
    { OMX_VIDEO_AVCProfileHigh444,     OMX_VIDEO_AVCLevel3  },
    { OMX_VIDEO_AVCProfileHigh444,     OMX_VIDEO_AVCLevel31 },
    { OMX_VIDEO_AVCProfileHigh444,     OMX_VIDEO_AVCLevel32 },
    { OMX_VIDEO_AVCProfileHigh444,     OMX_VIDEO_AVCLevel4  },
    { OMX_VIDEO_AVCProfileHigh444,     OMX_VIDEO_AVCLevel41 },
    { OMX_VIDEO_AVCProfileHigh444,     OMX_VIDEO_AVCLevel42 },
    { OMX_VIDEO_AVCProfileHigh444,     OMX_VIDEO_AVCLevel5  },
    { OMX_VIDEO_AVCProfileHigh444,     OMX_VIDEO_AVCLevel51 },
    { OMX_VIDEO_AVCProfileHigh444,     OMX_VIDEO_AVCLevel52 },
...
void SoftAVC::logVersion() {
    ...
    if (status != IV_SUCCESS) {
        ALOGE("Error in getting version number: 0x%x", s_ctl_op.u4_error_code);
    } else {
        ALOGV("Ittiam decoder version number: %s", (char *)s_ctl_ip.pv_version_buffer);
    }
    return;
}
...
/*
int main(){
	 android::SoftAVC* a = new android::SoftAVC("OMX.google.h264.decoder", NULL,NULL,NULL);
     a->initDecoder();
     return 0;
}
*/